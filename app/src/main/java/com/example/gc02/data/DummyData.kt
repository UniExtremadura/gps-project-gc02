...
val dummyArticulos: List<Article> = listOf(
    Article(1, "Laptop", "Laptop de última generación", "1299.99"),
    Article(2, "Teléfono", "Teléfono inteligente de gama alta", "799.99"),
    Article(3, "Auriculares", "Auriculares inalámbricos con cancelación de ruido", "149.99"),
    Article(4, "Smartwatch", "Smartwatch con seguimiento de actividad", "199.99"),
    Article(5, "Tablet", "Tablet con pantalla retina", "499.99"),
    Article(6, "Cámara", "Cámara digital de alta resolución", "599.99"),
    Article(7, "Altavoces", "Altavoces Bluetooth de calidad premium", "129.99"),
    Article(8, "Impresora", "Impresora láser todo en uno", "299.99"),
